                    ...
                    <div class="table-responsive">
                        <table class="table table-hover" id="tbl">
                                <thead>
                                    ...
                                    <th class="col-md-1" scope="col">Selling Price</th>

                            <th class="col-md-1" scope="col">Created Date</th>
                            <th class="col-md-1" scope="col"> Status</th>
                            <th class="col-md-2" scope="col" colspan="4" class="text-center">Action
                            </th>
                            </tr>
                            </thead>
                            <tbody>
                                    ...
                                    <td class="text-left">
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" role="menu" style="">
                                              <a href="{{ route('images.show', ['id' => $product->id]) }}" class="dropdown-item">Add / View Images</a>
                                              <a href="{{ route('product.edit', ['id' => $product->id]) }}" class="dropdown-item">Edit</a>
                                            </div>
                                          </div>
