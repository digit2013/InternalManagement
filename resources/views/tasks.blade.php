                ...
                <div class="row dflex">
                    ...
                    <div class="col-md-6 float-left">
                        <ul class="pagination pagination-md ">
                          @if ($task_heads->hasMorePages())
                              <a href="{{ $task_heads->nextPageUrl() }}" class="btn btn-default m-1 p-2">Next</a>
                          @endif
                          @if($task_heads->currentPage() > 1)
                              <a href="{{ $task_heads->previousPageUrl() }}" class="btn btn-default m-1 p-2">Prev</a>
                          @endif
                        </ul>
                    </div>
                </div>
